...
// //     const { databaseName, dbTableName } = state;
// //     const [columnMappings, setColumnMappings] = useState([{ dbColumnName: '', fileColumns:[{fileColumnName: '', fileName: '', fileSource: '' }]}]);

// //     const handleAddFileColumn = (index) => {
// //         const updatedMapping=[...columnMappings];
// //         updatedMapping[index].fileColumns.push({fileColumnName:'',fileName:'',fileSource:''});
// //         setColumnMappings(updatedMapping);
// //     };

// //     const handleDeleteFileColumn = (dbIndex,fileIndex) => {
// //         const updatedMapping=[...columnMappings];
// //         updatedMapping[dbIndex].fileColumns.splice(fileIndex,1);
// //         setColumnMappings(updatedMapping);
// //     };

// //     const handleAddDbColumn = () => {
// //         setColumnMappings([...columnMappings,{dbColumnName:'',fileColumns:[{fileColumnName: '', fileName: '', fileSource: '' }]}]);
// //     };
...
// //                             <p>Table :{dbTableName}</p>

// //                             {columnMappings.map((mapping, dbIndex) => (
// //                                 <div key={dbIndex}>
// //                                     <div>
// //                                     <input type='text' placeholder='DB Column Name' value={mapping.dbColumnName} onChange={(e) => {
// //                                         const updatedMapping = [...columnMappings];
// //                                         updatedMapping[dbIndex].dbColumnName = e.target.value;
// //                                         setColumnMappings(updatedMapping);
// //                                     }} />
// //                                     </div>
// //                                     {mapping.fileColumns.map((fileColumn,fileIndex)=>(
// //                                         <div key={fileIndex}>
// //                                         <input type='text' placeholder='File Column Name' value={fileColumn.fileColumnName} onChange={(e) => {
// //                                             const updatedMapping = [...columnMappings];
// //                                             updatedMapping[dbIndex].fileColumns[fileIndex].fileColumnName = e.target.value;
// //                                             setColumnMappings(updatedMapping);
// //                                         }} />
// //                                         <input type='text' placeholder='File Name' value={fileColumn.fileName} onChange={(e) => {
// //                                             const updatedMapping = [...columnMappings];
// //                                             updatedMapping[dbIndex].fileColumns[fileIndex].fileName = e.target.value;
// //                                             setColumnMappings(updatedMapping);
// //                                         }} />
// //                                         <input type='text' placeholder='File Source' value={fileColumn.fileSource} onChange={(e) => {
// //                                             const updatedMapping = [...columnMappings];
// //                                             updatedMapping[dbIndex].fileColumns[fileIndex].fileSource = e.target.value;
// //                                             setColumnMappings(updatedMapping);
// //                                         }} />
// //                                         <button onClick={() => handleDeleteFileColumn(index)}>Delete File Column</button>
// //                                         </div>
// //                                     ))}
...
// //                             <button onClick={() => NavigationPreloadManager(-1)}>Cancel</button>
// //                         </div>
// //                     </div>
// //                 </div>
// //             </div>
...
//         const grouped = {};
//         data.forEach((row) => {
//             row.tableColumns.forEach((column)=>{
//                 if (!grouped[column.columnName]) {
//                     grouped[column.columnName] = [];
//                 }
//                 column.fileColumns.forEach((fileColumn)=>{
//                     grouped[column.columnName].push({
//                         fileColumnName:fileColumn.columnName,
//                         fileName:fileColumn.fileName,
//                         fileSource:fileColumn.fileSource
//                     });
//                 });
//             });
